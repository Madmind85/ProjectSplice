...
DECLARE_CYCLE_STAT(TEXT("KLS Foot Placement Eval"), STAT_FootPlacement_Eval, STATGROUP_Anim);

#if ENABLE_ANIM_DEBUG
static TAutoConsoleVariable<bool> CVarAnimNodeFootPlacementEnable(TEXT("a.AnimNode.KLSFootPlacement.Enable"), true, TEXT("Enable/Disable Foot Placement"));
static TAutoConsoleVariable<bool> CVarAnimNodeFootPlacementEnableLock(TEXT("a.AnimNode.KLSFootPlacement.Enable.Lock"), true, TEXT("Enable/Disable Foot Locking"));
static TAutoConsoleVariable<bool> CVarAnimNodeFootPlacementDebug(TEXT("a.AnimNode.KLSFootPlacement.Debug"), false, TEXT("Turn on visualization debugging for Foot Placement"));
static TAutoConsoleVariable<bool> CVarAnimNodeFootPlacementDebugTraces(TEXT("a.AnimNode.KLSFootPlacement.Debug.Traces"), false, TEXT("Turn on visualization debugging for foot ground traces"));
static TAutoConsoleVariable<int> CVarAnimNodeFootPlacementDebugDrawHistory(TEXT("a.AnimNode.KLSFootPlacement.Debug.DrawHistory"), 0,
...
namespace UE::Anim::KLSFootPlacement
{
	...
	{
		const FVector IntersectionLoc = UE::Anim::KLSFootPlacement::PointDirectionPlaneIntersection(
			Location,
			-ApproachDir,
			PlantPlane);
...
void FAnimNode_KLSFootPlacement::FindPelvisOffsetRangeForLimb(
...
{
	const UE::Anim::KLSFootPlacement::FLegRuntimeData::FInputPoseData& LegInputPose = LegData.InputPose;
	const UE::Anim::KLSFootPlacement::FLegRuntimeData::FBoneData& Bones = LegData.Bones;
...
float FAnimNode_KLSFootPlacement::CalcTargetPlantPlaneDistance(
	const UE::Anim::KLSFootPlacement::FEvaluationContext& Context,
	const UE::Anim::KLSFootPlacement::FLegRuntimeData::FInputPoseData& LegInputPose) const
{
	...
	const float FootBaseDistance = 
		UE::Anim::KLSFootPlacement::GetDistanceToPlaneAlongDirection(LegInputPose.FootTransformCS.GetLocation(), IKGroundPlaneCS, Context.ApproachDirCS);
	const float BallBaseDistance = 
		UE::Anim::KLSFootPlacement::GetDistanceToPlaneAlongDirection(IKBallBoneCS.GetLocation(), IKGroundPlaneCS, Context.ApproachDirCS);
...
void FAnimNode_KLSFootPlacement::AlignPlantToGround(
	const UE::Anim::KLSFootPlacement::FEvaluationContext& Context,
	...
	FQuat& OutTwistCorrection) const
{
	...
	const float IKFootRootToFootRootTargetDistance = 
		UE::Anim::KLSFootPlacement::GetDistanceToPlaneAlongDirection(InputPoseFootTransformWS.GetLocation(), IKFootRootPlaneWS, Context.ApproachDirWS);

	const FVector CorrectedPlaneIntersectionWS = UE::Anim::KLSFootPlacement::PointDirectionPlaneIntersection(
...
FTransform FAnimNode_KLSFootPlacement::UpdatePlantOffsetInterpolation(
	const UE::Anim::KLSFootPlacement::FEvaluationContext& Context,
...
void FAnimNode_KLSFootPlacement::UpdatePlantingPlaneInterpolation(
	const UE::Anim::KLSFootPlacement::FEvaluationContext& Context,
	...
	UE::Anim::KLSFootPlacement::FLegRuntimeData::FInterpolationData& InOutInterpData) const
{
	...
	if (bTraceAgainstSimpleAndComplex &&!FMath::IsNearlyEqual(AlignmentAlpha, 1.0f))
	{
		...
		UE::Anim::KLSFootPlacement::FindPlantPlane(Context, TraceSettings, FootTransformWS.GetLocation(), false, InOutPlantPlane, ImpactLocationSimpleWS);
		UE::Anim::KLSFootPlacement::FindPlantPlane(Context, TraceSettings, FootTransformWS.GetLocation(), true, InOutPlantPlane, ImpactLocationComplexWS);
	...
	else
	{
		...
		UE::Anim::KLSFootPlacement::FindPlantPlane(Context, TraceSettings, FootTransformWS.GetLocation(), true, InOutPlantPlane, ImpactLocationWS);
	}

	if (InterpolationSettings.bEnableFloorInterpolation)
	{
		FVector CurrPlaneIntersection = UE::Anim::KLSFootPlacement::PointDirectionPlaneIntersection(
			FootTransformWS.GetLocation(),
			TraceDirection,
			InOutPlantPlane);

		const FVector LastPlaneIntersection =UE::Anim::KLSFootPlacement::PointDirectionPlaneIntersection(
			LastAlignedFootTransform.GetLocation(),
			TraceDirection,
			LastPlantPlane);

		const FVector PrevPlaneIntersection = UE::Anim::KLSFootPlacement::PointDirectionPlaneIntersection(
			FootTransformWS.GetLocation(),
			TraceDirection,
			LastPlantPlane);
		...
		if (TraceSettings.MaxGroundPenetration >= 0.0f)
		{
			...
			const float DistanceToGroundPlane =
				UE::Anim::KLSFootPlacement::GetDistanceToPlaneAlongDirection(CurrPlaneIntersection, InOutPlantPlane, Context.ApproachDirCS);
...
void FAnimNode_KLSFootPlacement::DeterminePlantType(
	const UE::Anim::KLSFootPlacement::FEvaluationContext& Context,
	...
	const UE::Anim::KLSFootPlacement::FLegRuntimeData::FInputPoseData& LegInputPose) const
{
	using namespace UE::Anim::KLSFootPlacement;
	...
	else if (!bWantedToPlant)
	{
		...
		InOutPlantData.PlantType = UE::Anim::KLSFootPlacement::EPlantType::Planted;
	}
	else // Test for re-plant
	{
		...
		{
			InOutPlantData.PlantType = UE::Anim::KLSFootPlacement::EPlantType::Replanted;
		}
	}
}

float FAnimNode_KLSFootPlacement::GetMaxLimbExtension(const float DesiredExtension, const float LimbLength) const
{
...
float FAnimNode_KLSFootPlacement::GetMinLimbExtension(const float DesiredExtension, const float LimbLength) const
{
	return FMath::Min(DesiredExtension, LimbLength * PlantSettings.MinExtensionRatio);
}

void FAnimNode_KLSFootPlacement::ResetRuntimeData() 
{
	PelvisData.Interpolation = UE::Anim::KLSFootPlacement::FPelvisRuntimeData::FInterpolationData();
	...
	{
		UE::Anim::KLSFootPlacement::FLegRuntimeData& LegData = LegsData[LegIndex];
		LegData.Idx = LegIndex;
		LegData.Interpolation = UE::Anim::KLSFootPlacement::FLegRuntimeData::FInterpolationData();
	}
...
bool FAnimNode_KLSFootPlacement::WantsToPlant(
	const UE::Anim::KLSFootPlacement::FEvaluationContext& Context,
	const UE::Anim::KLSFootPlacement::FLegRuntimeData::FInputPoseData& LegInputPose) const
{
#if ENABLE_ANIM_DEBUG
...
float FAnimNode_KLSFootPlacement::GetAlignmentAlpha(
	const UE::Anim::KLSFootPlacement::FEvaluationContext& Context,
	const UE::Anim::KLSFootPlacement::FLegRuntimeData::FInputPoseData& LegInputPose) const
{
	return FMath::Clamp(
...
FTransform FAnimNode_KLSFootPlacement::GetFootPivotAroundBallWS(
	const UE::Anim::KLSFootPlacement::FEvaluationContext& Context,
	const UE::Anim::KLSFootPlacement::FLegRuntimeData::FInputPoseData& LegInputPose,
...
UE::Anim::KLSFootPlacement::FPlantResult FAnimNode_KLSFootPlacement::FinalizeFootAlignment(
	const UE::Anim::KLSFootPlacement::FEvaluationContext& Context,
	...
	const FTransform& PelvisTransformCS)
{
	...
	{
		{
			...
			{
				const bool bIsPlanted = LegData.Plant.PlantType != UE::Anim::KLSFootPlacement::EPlantType::Unplanted;
				const bool bWasPlanted = LegData.Plant.LastPlantType != UE::Anim::KLSFootPlacement::EPlantType::Unplanted;
	...
	const float FootDistance = UE::Anim::KLSFootPlacement::GetDistanceToPlaneAlongDirection(
		CorrectedBallLocationCS,
		LegData.Plant.PlantPlaneCS,
		Context.ApproachDirCS);
	const float BallDistance = UE::Anim::KLSFootPlacement::GetDistanceToPlaneAlongDirection(
	...
	UE::Anim::KLSFootPlacement::FPlantResult Result =
	{
...
#if ENABLE_ANIM_DEBUG
void FAnimNode_KLSFootPlacement::DrawDebug(
	const UE::Anim::KLSFootPlacement::FEvaluationContext& Context,
	const UE::Anim::KLSFootPlacement::FLegRuntimeData& LegData,
	const UE::Anim::KLSFootPlacement::FPlantResult& PlantResult) const
{
	...
	{
	case UE::Anim::KLSFootPlacement::EPlantType::Planted: CurrentPlantColor = PlantedColor; break;
	case UE::Anim::KLSFootPlacement::EPlantType::Unplanted: CurrentPlantColor = UnplantedColor; break;
	case UE::Anim::KLSFootPlacement::EPlantType::Replanted: CurrentPlantColor = ReplantedColor; break;
	...
	const FVector FKBoneLocationProjectedWS = UE::Anim::KLSFootPlacement::PointDirectionPlaneIntersection(
	...
	const FVector IKBoneLocationProjectedWS = UE::Anim::KLSFootPlacement::PointDirectionPlaneIntersection(
	...
	const FVector PlantCenter = UE::Anim::KLSFootPlacement::PointDirectionPlaneIntersection(
		IKBoneTransformWS.GetLocation(),
		Context.ApproachDirWS,
		LegData.Plant.PlantPlaneWS);
...
FAnimNode_KLSFootPlacement::FAnimNode_KLSFootPlacement()
{
}

// TODO: implement 
void FAnimNode_KLSFootPlacement::GatherDebugData(FNodeDebugData& NodeDebugData)
{
	ComponentPose.GatherDebugData(NodeDebugData);
}

void FAnimNode_KLSFootPlacement::Initialize_AnyThread(const FAnimationInitializeContext& Context)
{
	FAnimNode_SkeletalControlBase::Initialize_AnyThread(Context);
	ResetRuntimeData();
}

void FAnimNode_KLSFootPlacement::UpdateInternal(const FAnimationUpdateContext& Context)
{
...
void FAnimNode_KLSFootPlacement::EvaluateSkeletalControl_AnyThread(FComponentSpacePoseContext& Output,
	TArray<FBoneTransform>& OutBoneTransforms)
{
...
#if ENABLE_ANIM_DEBUG
	UE::Anim::KLSFootPlacement::FDebugData LastDebugData = DebugData;
#endif

	// TODO: Support a different approach direction
	const FVector ApproachDirCS = -FVector::UpVector;
	UE::Anim::KLSFootPlacement::FEvaluationContext FootPlacementContext(Output, ApproachDirCS, CachedDeltaTime);
	...
	{
		UE::Anim::KLSFootPlacement::FLegRuntimeData& LegData = LegsData[FootIndex];
	...
	for (UE::Anim::KLSFootPlacement::FLegRuntimeData& LegData : LegsData)
	{
	...
	for (int32 FootIndex = 0; FootIndex < LegsData.Num(); ++FootIndex)
	{
		...
		const UE::Anim::KLSFootPlacement::FPlantResult PlantResult =
...
bool FAnimNode_KLSFootPlacement::IsValidToEvaluate(const USkeleton* Skeleton, const FBoneContainer& RequiredBones)
{
#if ENABLE_ANIM_DEBUG
	...
	for (const UE::Anim::KLSFootPlacement::FLegRuntimeData& LegData : LegsData)
	{
...
void FAnimNode_KLSFootPlacement::InitializeBoneReferences(const FBoneContainer& RequiredBones)
{
	LegsData.Reset();
	LegsData.SetNumUninitialized(LegDefinitions.Num());
	for (int32 FootIndex = 0; FootIndex < LegsData.Num(); ++FootIndex)
	{
		...
		UE::Anim::KLSFootPlacement::FindChainLengthRootBoneIndex(
...
void FAnimNode_KLSFootPlacement::GatherPelvisDataFromInputs(const UE::Anim::KLSFootPlacement::FEvaluationContext& Context)
{
...
void FAnimNode_KLSFootPlacement::GatherLegDataFromInputs(
	const UE::Anim::KLSFootPlacement::FEvaluationContext& Context,
	UE::Anim::KLSFootPlacement::FLegRuntimeData& LegData,
	const FFootPlacemenLegDefinition& LegDef)
{
	...
	if (bIsFirstUpdate)
	{
		...
		LegData.Plant.PlantType = UE::Anim::KLSFootPlacement::EPlantType::Unplanted;
		LegData.Plant.LastPlantType = UE::Anim::KLSFootPlacement::EPlantType::Unplanted;
...
void FAnimNode_KLSFootPlacement::CalculateFootMidpoint(const UE::Anim::KLSFootPlacement::FEvaluationContext& Context, TConstArrayView<UE::Anim::KLSFootPlacement::FLegRuntimeData> InLegsData, FVector& OutMidpoint) const
{
	int32 NumLegs = LegsData.Num();
	OutMidpoint = FVector::ZeroVector;
	for (const UE::Anim::KLSFootPlacement::FLegRuntimeData& LegData : InLegsData)
	{
		OutMidpoint += LegData.InputPose.FootTransformCS.GetLocation() / NumLegs;
	}
}

void FAnimNode_KLSFootPlacement::ProcessCharacterState(const UE::Anim::KLSFootPlacement::FEvaluationContext& Context)
{
	...
	if (CharacterData.bIsOnGround && bWasOnGround && (PelvisSettings.ActorMovementCompensationMode != EActorMovementCompensationMode::ComponentSpace))
	{
		...
		if (PelvisSettings.ActorMovementCompensationMode == EActorMovementCompensationMode::SuddenMotionOnly)
		{
			...
			OwningComponentAdjustedLastLocationWS =
				...
				UE::Anim::KLSFootPlacement::PointDirectionPlaneIntersection(
					ComponentLocationWS,
					Context.ApproachDirWS,
...
void FAnimNode_KLSFootPlacement::ProcessFootAlignment(
	const UE::Anim::KLSFootPlacement::FEvaluationContext& Context,
	UE::Anim::KLSFootPlacement::FLegRuntimeData& LegData)
{
	UE::Anim::KLSFootPlacement::FLegRuntimeData::FInputPoseData& InputPose = LegData.InputPose;
	UE::Anim::KLSFootPlacement::FLegRuntimeData::FInterpolationData& Interpolation = LegData.Interpolation;
	UE::Anim::KLSFootPlacement::FLegRuntimeData::FBoneData& Bones = LegData.Bones;
	UE::Anim::KLSFootPlacement::FLegRuntimeData::FPlantData& Plant = LegData.Plant;
	...
	const bool bIsPlanted = Plant.PlantType != UE::Anim::KLSFootPlacement::EPlantType::Unplanted;
	const bool bWasPlanted = Plant.LastPlantType != UE::Anim::KLSFootPlacement::EPlantType::Unplanted;
	...
	if (PlantSettings.SeparatingDistance > 0.0f)
	{
		...
		const float DistanceToSeparatingPlane =
			UE::Anim::KLSFootPlacement::GetDistanceToPlaneAlongDirection(FootUnalignedLocationCS, SeparatingPlane, -PlaneNormal);
...
FVector FAnimNode_KLSFootPlacement::GetApproachDirWS(const FAnimationBaseContext& Context) const
{
...
FTransform FAnimNode_KLSFootPlacement::SolvePelvis(const UE::Anim::KLSFootPlacement::FEvaluationContext& Context)
{
	using namespace UE::Anim::KLSFootPlacement;
...
TBitArray<> FAnimNode_KLSFootPlacement::FindRelevantFeet(const UE::Anim::KLSFootPlacement::FEvaluationContext& Context)
{
...
TBitArray<> FAnimNode_KLSFootPlacement::FindPlantedFeet(const UE::Anim::KLSFootPlacement::FEvaluationContext& Context)
{
...
FTransform FAnimNode_KLSFootPlacement::UpdatePelvisInterpolation(
	const UE::Anim::KLSFootPlacement::FEvaluationContext& Context,
...
void FAnimNode_KLSFootPlacement::CacheBones_AnyThread(const FAnimationCacheBonesContext& Context)
{
	GetEvaluateGraphExposedInputs().Execute(Context);
	LegDefinitions.Reset();
	for(FFootPlacemenLegDefinitionNames LegDefinition : TheLegDefinitions)
	{
		FFootPlacemenLegDefinition FinalDef;
		FinalDef.BallBone = FBoneReference(LegDefinition.BallBone);
		FinalDef.BallBone.BoneIndex = INDEX_NONE;
		
		FinalDef.FKFootBone = FBoneReference(LegDefinition.FKFootBone);
		FinalDef.FKFootBone.BoneIndex = INDEX_NONE;
		
		FinalDef.IKFootBone = FBoneReference(LegDefinition.IKFootBone);
		FinalDef.IKFootBone.BoneIndex = INDEX_NONE;
		
		FinalDef.NumBonesInLimb = LegDefinition.NumBonesInLimb;
		FinalDef.SpeedCurveName = LegDefinition.SpeedCurveName;
		FinalDef.DisableLockCurveName = LegDefinition.DisableLockCurveName;
		LegDefinitions.Add(FinalDef);
	}

	PelvisBone = FBoneReference(PelvisBoneName);
	PelvisBone.BoneIndex = INDEX_NONE;
	
	IKFootRootBone = FBoneReference(IKFootRootBoneName);
	IKFootRootBone.BoneIndex = INDEX_NONE;
