...
#include "AnimNode_KLSOrientationWarping.generated.h"

USTRUCT(BlueprintInternalUseOnly)
struct KAILOCOMOTION_API FAnimNode_KLSOrientationWarping : public FAnimNode_SkeletalControlBase
{
	GENERATED_BODY()
	...
	UPROPERTY(EditAnywhere,BlueprintReadWrite, Category=Settings, meta=(PinHiddenByDefault), meta=(DisplayName="IK Foot Root Bone"))
	...
	// IK Foot definitions
	UPROPERTY(EditAnywhere,BlueprintReadWrite, Category=Settings, meta=(PinHiddenByDefault), meta=(DisplayName="IK Foot Bones"))
	TArray<FName> IKFootBonesNames;
