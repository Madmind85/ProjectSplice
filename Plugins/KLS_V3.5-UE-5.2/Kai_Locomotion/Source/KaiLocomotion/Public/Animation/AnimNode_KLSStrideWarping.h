...
#include "AnimNode_KLSStrideWarping.generated.h"



USTRUCT(BlueprintInternalUseOnly)
struct KAILOCOMOTION_API FAnimNode_KLSStrideWarping : public FAnimNode_SkeletalControlBase
{
	GENERATED_BODY()
	...
	// Pelvis Bone definition
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category=Settings, meta=(DisplayName="Pelvis Bone"), meta=(PinHiddenByDefault))
	FName PelvisBoneName = "None";
	
	UPROPERTY()
	FBoneReference PelvisBone;

	// IK Foot Root Bone definition
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category=Settings, meta=(DisplayName="IK Foot Root Bone"), meta=(PinHiddenByDefault))
	FName IKFootRootBoneName = "None";
	...
	UPROPERTY(EditAnywhere,BlueprintReadWrite, Category=Settings, meta=(DisplayName="Foot Definitions"), meta=(PinShownByDefault))
	TArray<FStrideWarpingFootDefinitionName> FootDefinitionsNames;
...
public:
	...
	void UpdateBoneReferencesFromNames();
private:
	// FAnimNode_SkeletalControlBase interface
